...
// scriptin/jmdict-simplified contain exactly one .json file each, so we
// don't need a general-purpose tar parser — just enough to read the size
// out of the 512-byte header and slice out the payload.
//
// Tar format reference: https://www.gnu.org/software/tar/manual/html_node/Standard.html
//
// Ported verbatim from Pureyaa src/onboarding/tar.ts.
