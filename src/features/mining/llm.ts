...
// OpenRouter model slug for the analysis pass. Sonnet handles Japanese
// grammar nuance noticeably better than Haiku / GPT-4o-mini at a per-
...
function normalize(raw: unknown): CueTranslation | null {
  ...
  const grammarNote = typeof note === "string" && note.trim().length > 0 ? note : null;
